...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../assets/images/logo-min.avif"><!-- Favicon / Icon -->
...
<body>
    ...
    <header class="header">
        <a href="#" class="logo">
            <img src="../assets/images/logo-min.avif" class="img-logo" alt="KapeTann Logo">
        </a>
    ...
    <section class="footer">
        <div class="footer-container">
            <div class="logo">
                <img src="../assets/images/logo-min.avif" class="img"><br />
